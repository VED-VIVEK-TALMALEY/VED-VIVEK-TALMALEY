...
CELL_W = 8
CELL_H = 15
RAMP = " .'-r*s%#@"  # Fewer muddy mid-tones, sharper transitions
...
parts.append(
    ...
    f'text-anchor="middle">Ved@github: ~$ ./portrait.sh</text>'
)
...
parts.append(
    ...
    f'Ved@github:~$ whoami <tspan fill="{INK}">Ved Talmaley</tspan></text>'
)
parts.append(
